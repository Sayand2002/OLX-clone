            ...
            <div className="carousal-container">
                ...
                <div className="details flex flex-col ">
                    ...
                    <div className="p-5">
                        ...
                        <ul>
                            <li>
                                <p className="py-3">description about the product</p>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="product-data flex flex-col justify-between p-4">
                    <span>
                        <span className="flex justify-between">
                            <h1 className="text-4xl font-semibold">₹ 40,000</h1>
                        ...
                        <p className="pt-3 overflow-ellipsis text-lg">Name of the product....</p>
                    </span>
                    <span className="flex justify-between">
                        <p className="overflow-hidden w-4/5 h-6">location</p>
                        <p className="w-1/6 h-6 overflow-hidden">time</p>
                    </span>
                </div>
