...
const ItemCard = () => {
    return(
        <div className="card-container">
            <div className="item-img bg-no-repeat" style={{backgroundImage:"url(./src/assets/desk-office.jpg)"}}>
            ...
            <div className="item-details w-full px-5 py-1 flex flex-col">
                <span className="item-price text-lg font-bold">₹ 4,000</span>
                <span className="item-name text-sm" style={{color:"rgba(0,47,52,0.64)"}}>Item Name  </span>
                <span className=" flex justify-between items-end h-8 text-xs pb-1" style={{color:"rgba(0,47,52,0.64)"}}>
                    <span className="location">kerala, kannur,thalassery </span>
